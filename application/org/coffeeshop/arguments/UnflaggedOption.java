...
public final class UnflaggedOption extends Option {
     ...
     */
    private boolean greedy = Arguments.NOT_GREEDY;
    ...
    public UnflaggedOption(
        ...
        setStringParser(stringParser);
        setRequired(required);
        setGreedy(Arguments.NOT_GREEDY);
        setHelp(help);
    }
    ...
    public String getSyntax() {
        ...
        if (this.isGreedy()) {
            result.append(un + "1" + Arguments.SYNTAX_SPACECHAR + un + "2" + Arguments.SYNTAX_SPACECHAR + "..." + Arguments.SYNTAX_SPACECHAR + un + "N");
        } else {
            result.append("<" + un + ">");
        }
        if (!required()) {
