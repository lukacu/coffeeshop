...
/** Encapsulates the results of the parse() methods.  The most basic means of
 * obtaining a parse result from a ArgumentResult is the {@link #getObject(String)}
 * method, but a number of getXXX() methods are provided
 * to make your code more readable and to avoid re-casting.
 * 
 * @author <a href="http://www.martiansoftware.com/contact.html">Marty Lamb</a>
 */
public class ArgumentsResult implements ExceptionMap {

    /**
     * Contains all of the results, as a Map of Lists keyed by
     * parameter ID.
     */
    private Map<String, List<Object>> allResults = null;

    /**
     * Contains a map of the QualifiedSwitch IDs with Booleans
     * indicating whether they were present.
     */
    private Map<String, Boolean> qualifiedSwitches = null;
     ...
     * key.
     */
    private Map<String, List<Exception>> allExceptions = null;

    /**
     * A chronological listing of all of the exceptions thrown during parsing.
     */
    private List<String> chronologicalErrorMessages = null;

    /**
     * A set containing the IDs of parameters supplied by the user
     * (as opposed to default values)
     */
    private Set<String> userSpecifiedIDs = null;
    
    /**
     * If true, any values "add"ed to this ArgumentResult came from the
     * user, and not from any default values.
     */
    private boolean valuesFromUser = false;
    
    /**
     *  Creates new ArgumentResult
     */
    protected ArgumentsResult() {
        allResults = new java.util.HashMap<String, List<Object>>();
        allExceptions = new java.util.HashMap<String, List<Exception>>();
        chronologicalErrorMessages = new java.util.LinkedList<String>();
        qualifiedSwitches = new java.util.HashMap<String, Boolean>();
        userSpecifiedIDs = new java.util.HashSet<String>();
    }

    /**
     * Sets internal flag indicating sources of subsequent values
     * added to this ArgumentResult
     * @param valuesFromUser if true, values subsequently added to
     * this ArgumentResult originated from the user.
     */
    ...
    /**
     * Returns true if this ArgumentResult contains any results for
     ...
     * @return true if there are any values in this ArgumentResult associated
    ...
    /**
     * Returns true if this ArgumentResult contains any <i>user-specified</i>
     * values for the specified id.  If this ArgumentResult contains default values
     ...
     * with the specified ID.
     */
    protected void add(String id, List<Object> values) {
        List<Object> al = null;
        if (allResults.containsKey(id)) {
            al = (List<Object>) allResults.get(id);
        } else {
    ...
    public Object[] getObjectArray(String id, Object[] a) {
        List<Object> al = (List<Object>) allResults.get(id);
        if (al == null) {
            al = new java.util.ArrayList<Object>();
        }
        return (al.toArray(a));
     ...
     * exist within this ArgumentResult, or if the object(s) associated with the
     ...
     * exist within this
     * ArgumentResult, or if the object(s) associated with the specified id are
     * not of type
     * java.lang.Boolean.
     ...
     * not exist within this ArgumentResult, this method returns an empty array
     * (i.e., array.length==0).
     * @param id the id of the boolean value(s) to return.
     * @return an array containing the boolean value(s) associated with the
     * specified id, or an
     * empty array if the specified id does not exist within this ArgumentResult.
     * @see #getBoolean(String)
     * @see #getBoolean(String,boolean)
     */
     ...
     * @param defaultValue the value to return if the specified id does not
     * exist within this
     * ArgumentResult, or if the object(s) associated with the specified id are not
     * of type
     ...
     * @see org.coffeeshop.arguments.ExceptionMap#getException(String)
     */
     ...
     * @see org.coffeeshop.arguments.ExceptionMap#getExceptionArray(String)
     */
    public Exception[] getExceptionArray(String id) {
        Exception[] result = new Exception[0];
        List<Exception> el = (List<Exception>) allExceptions.get(id);
        if (el != null) {
    ...
    /**
     * Informs the ArgumentResult of a QualifiedSwitch (necessary
